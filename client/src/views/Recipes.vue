<template>
  <div class="container-fluid recipes">
    ...
    <ul class="navbar">
      ...
      <li>
        <button
          class="nav-item nav-link btn btn-sm create-recipe-bg mb-5 mt-5"
          @click="addRecipe()"
        >
          Add Recipe
        </button>
      ...
      <li>
        <form class="nav-item form-inline my-2 my-lg-0">
          ...
          <input
            ...
            aria-label="Search"
          />
          <button class="btn my-2 my-sm-0 create-recipe-bg m-1" type="submit">
            Search
          </button>
        </form>
      </li>
        ...
        <ul class="nav nav-tabs" id="stationTab" role="tablist">
          <li class="nav-item stations">
            <a
              ...
              @click="getRecipes('Breakfast Bar')"
              id="breakfast-bar-tab"
              data-toggle="tab"
              href="#breakfast-bar"
              role="tab"
              aria-controls="breakfast-bar"
              aria-selected="true"
              >Breakfast Bar</a
            >
          </li>
          ...
          <li class="nav-item stations">
            <a
              class="nav-link"
              @click="getRecipes('Hot Entree')"
              id="hot-entree-tab"
              data-toggle="tab"
              href="#hot-entree"
              role="tab"
              aria-controls="hot-entree"
              aria-selected="false"
              >Hot Entree</a
            >
          </li>
          ...
          <li class="nav-item stations">
            <a
              class="nav-link"
              @click="getRecipes('Salad Bar')"
              id="salad-bar-tab"
              data-toggle="tab"
              href="#salad-bar"
              role="tab"
              aria-controls="salad-bar"
              aria-selected="false"
              >Salad Bar</a
            >
          </li>
          ...
          <li class="nav-item stations">
            <a
              class="nav-link"
              @click="getRecipes('Southwest')"
              id="southwest-tab"
              data-toggle="tab"
              href="#southwest"
              role="tab"
              aria-controls="southwest"
              aria-selected="false"
              >Southwest</a
            >
          </li>
          ...
          <li class="nav-item stations">
            <a
              ...
              @click="getRecipes('Chefs Choice')"
              id="chefs-choice-tab"
              data-toggle="tab"
              href="#chefs-choice"
              role="tab"
              aria-controls="chefs-choice"
              aria-selected="false"
              >Chef's Choice</a
            >
          </li>
      ...
      <div class="row">
        <div class="tab-content" id="myTabContent">
          <div
            ...
            id="breakfast-bar"
            role="tabpanel"
            aria-labelledby="breakfast-bar-tab"
          >
            <ul
            ...
            >
              <li class="recipe_list">
                ...
                <img
                  src="../assets/flag-filled-16.png"
                  alt="flagged"
                  title="flagged"
                  v-if="recipe.flag == true"
                  class="mb-1 ml-1 details-img"
                />
                <img
                  src="../assets/non-flag-filled-16.png"
                  alt="not-flagged"
                  title="not-flagged"
                  v-else
                  class="mb-1 ml-1 details-img"
                ...
                <span
                  ><img
                    src="../assets/Plus-Icon-18.png"
                    alt="Recipe Details"
                    title="Recipe Details"
                    @click="itemClicked(recipe)"
                    class="mb-1 ml-1 details-img"
                /></span>
              </li>
            </ul>
          ...
          <div
            ...
            id="chefs-choice"
            role="tabpanel"
            aria-labelledby="chefs-choice-tab"
          >
            <ul
              v-for="recipe in visibleRecipes"
              :key="recipe._id"
          ...
          <div
            ...
            id="hot-entree"
            role="tabpanel"
            aria-labelledby="hot-entree-tab"
          >
            <ul
              v-for="recipe in visibleRecipes"
              :key="recipe._id"
...
export default {
  ...
  methods: {
    ...
    updateVisibleRecipes() {
      this.visibleRecipes = this.recipes.slice(
