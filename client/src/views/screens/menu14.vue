<template>
  <div class="menu14" :id="mode" :key="rerender">
    <div id="menu14-border">
      <div class="container-fluid" id="menu14-body" @click="openFullscreen"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async checkRouter() {
        if (this.$router.currentRoute.path == "/menu14/cafe-17c") {
          this.kitchenName = "Cafe 17C";
          this.mode = "cafe17c"
          this.icon = require("../../assets/c17cSushiP353C1080px.png")
        } else if (this.$router.currentRoute.path == "/menu14/cafe-36") {
          this.kitchenName = "Cafe 36";
          this.mode = "cafe36"
          this.icon = require("../../assets/c36SushiP7408CP1080px.png")
        }
      },
      toggleTheme() {
