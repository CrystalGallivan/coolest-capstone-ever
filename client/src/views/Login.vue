        ...
        <div class="modal-content">
          ...
          <div v-else-if="user._id && !site._id" class="modal-body">
            ...
            <select
              ...
              id="owned"
              class="form-control mySite-input"
              placeholder="Owner"
              required
            >
            ...
            <select
              ...
              id="member"
              @change="selectSite($event)"
              class="form-control myMember-input"
              placeholder="Team Member"
              required
            >
              <option disabled value="">Choose Site</option>
              <option
                v-for="memberSite in memberSites"
                :value="memberSite._id"
                >{{ memberSite.name }}</option
              >
            </select>
          </div>
    ...
    <div class="row">
      <div class="card d-inline-flex col-4 offset-4" id="registerForm">
        <form @submit.prevent="registerUser">
          <img
            src="../assets/KitchenNinjaLogoColor.png"
            alt="Kitchen Ninja"
            id="kitchen-ninja-logo"
          />
