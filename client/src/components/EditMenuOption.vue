          ...
          <div class="modal-body">
            <div class="input-group" id="menu-option-input">
              <div class="input-group-prepend">
                <span class="input-group-text" id="edit-menu-option-title"
                  >Title</span
                >
              </div>
              <input
            ...
            <div class="input-group" id="menu-option-input">
              <div class="input-group-prepend">
                <span class="input-group-text" id="edit-menu-option-description"
                  >Description</span
                >
              </div>
              <ckeditor
                :editor="editor"
                class="form-control"
                v-model="menuOptionSelected.description"
                :config="editorConfig"
              >
              </ckeditor>
            </div>
