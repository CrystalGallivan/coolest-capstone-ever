<template>
  <div class="menu-days-list col-4 d-flex justify-content-center">
            ...
            <div class="dropdown dropleft float-right">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a
                  ...
                  class="dropdown-item"
                  @click="setTimeOfDay('breakfast')"
                  >Add Categories</a
                >
              </div>
            </div>
            <h6
              class="mb-1 mt-1 ml-3 dayTime"
              data-toggle="collapse"
              data-target="#collapseBreakfast"
            >
              Breakfast:
            </h6>
            <div class="collapse" id="collapseBreakfast">
              <div
                class="card mt-2 mr-1 categoryCard"
                v-for="category in day.breakfast"
                :key="category._id"
              >
                <div class="card-header">
                  <div class="dropdown dropleft float-right">
                    ...
                    >
                      <img
                        src="../assets/menu-vertical-25.png"
                        alt=""
                        srcset=""
                      />
                    </button>
                    ...
                    >
                      ...
                      <a
                        @click="deleteCategoryBreakfast(category._id, day)"
                        class="dropdown-item"
                        href="#"
                        >Delete Category</a
                      >
                  ...
                  <h5
                    class="card-title mb-0 ml-3 categoryTitle"
                    data-toggle="collapse"
                    data-target="#collapseBreakfastRecipes"
                ...
                <div
                  class="card-body addRecipeBody collapse"
                  id="collapseBreakfastRecipes"
                >
                  <h6 class="ml-4">
                    Add Recipe<button
                  ...
                  <div
                    ...
                    v-for="mRecipe in category.menuRecipes"
                    :key="mRecipe._id"
                  >
                    <div class="card-header p-1" style="height: fit-content;">
                      <div class="card-title p-1 m-0">
                        <button
                          ...
                          data-toggle="modal"
                          data-target="#deleteRecipeAlertModal"
                          @click="setActiveMRecipe(category, mRecipe)"
                        >
                          <img
                            src="../assets/X-gray-12.png"
                            class="mb-2"
                            title="Delete Recipe"
                          />
                        </button>
                    ...
                    <div class="card-body m-0 recipeBody">
                      <div class="row">
                        <div class="col-12">
                          <small v-for="allergen in mRecipe.allergens"
                            >Contains: {{ allergen }}</small
                          >
                        </div>
                        <div class="col-12">
                          <small
                            >Description: {{ mRecipe.menuDescription }}</small
                          >
                        </div>
                        <div class="col-12">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <h6
              class="mb-1 mt-1 ml-3 dayTime"
              data-toggle="collapse"
              data-target="#collapseLunch"
            >
              Lunch:
            </h6>
            <div class="collapse in" id="collapseLunch">
              <div
                class="card mt-2 categoryCard"
                v-for="category in day.lunch"
                :key="category._id"
              >
                <div class="card-header">
                  <div class="dropdown dropleft float-right">
                    ...
                    >
                      <!-- TODO Add that an admin can also delete categories; how to get user role? -->
                      <a
                        @click="deleteCategoryLunch(category._id, day)"
                        class="dropdown-item"
                        href="#"
                        >Delete Category</a
                      >
                  ...
                  <h5
                    class="card-title m-1 ml-3 categoryTitle"
                    data-toggle="collapse"
                    data-target="#collapseRecipes"
                    @click="setActiveCategory(category, day)"
                  >
                    {{ category.title }}
                  </h5>
    ...
    <div
      class="modal fade"
      id="deleteRecipeAlertModal"
      tabindex="-1"
      role="dialog"
      aria-labelledby="deleteRecipeAlertModalLabel"
      aria-hidden="true"
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
