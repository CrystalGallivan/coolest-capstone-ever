        ...
        <div class="card-body">
          <div class="dropdown dropleft float-right">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a @click="deleteMenu(menu._id)" class="dropdown-item" href="#"
                >Delete Menu</a
              >
          ...
          <h5
            class="card-title ml-4 open-menu"
            @click="openMenu(menu, menu._id)"
          >
            {{ menu.week }}
          </h5>
          <p class="card-text">{{ menu.title }}</p>
          <p class="card-text">
            {{ menu.kitchenId | findKitchenName(kitchens) }}
          </p>
